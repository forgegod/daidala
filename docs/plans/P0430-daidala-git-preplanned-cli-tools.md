...
3. Prove native, standalone, and tool projections delegate to the same service and agree on valid output, stale preview rejection, invalid selectors, and no pre-apply ledger/Kanban/worktree mutation.
