...
9. State the dashboard boundary explicitly: P0207 implements service and CLI authority; P0210 establishes exact-plan approval while P0212 later renders review disposition and revision in the Hermes dashboard. Do not document unimplemented browser controls as current behavior.
...
- Do not implement dashboard presentation in this plan; P0210 and P0212 consume these exact service operations.
