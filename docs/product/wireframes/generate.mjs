...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; } body { margin:0; width:1440px; min-height:1680px; overflow:hidden; background:var(--bg); color:var(--text); font:14px/1.4 Inter,ui-sans-serif,system-ui,sans-serif; }
