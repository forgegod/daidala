...
<section class="workspace"><p class="eyebrow">Configuration</p><p class="intro">Profile-local settings use server-derived identity and explicit preview confirmation.</p><div class="config-tabs"><span class="active">Packs</span><span>Registered projects</span><span>GitHub Projects</span><span>Checkouts</span><span>Constraints</span><span>Verification</span><span>Runbook</span></div>
  ...
  <div class="shell">
    ...
    <main class="main">
      ...
      <section class="workspace">
        ...
        <section class="guidance"><div><b>Workflow supervision</b><p>Use Workflows to inspect approval-gated progress and make the next required human decision from source-bound evidence.</p></div><div class="advice"><b>Start workspace</b><p>Registered project · bound board</p><p>Existing unregistered project · clean Git board</p><p>Initialize local project · policy and initial commit</p><div class="button">Start workflow</div></div></section>
