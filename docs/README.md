...
|---|---|---|
| [Getting started](00-getting-started.md) | Native first-workflow path verified on Hermes v0.18.2, v0.19.0, and v0.20.0 | Isolated native lifecycle probe and CLI tests |
...
| [Hermes integration](08-hermes-integration.md) | Exact Hermes v0.18.2, v0.19.0, and v0.20.0 hosts supported within `>=0.18.2,<0.21.0` | Isolated repeated exact-wheel probes, compatible comparisons, and release-only compatibility regression |
...
| [Autonomous triggering](13-autonomous-triggering.md) | Hermes Cron/webhook admission composition documented; script-only/no-agent artifact curation scheduling exercised in an isolated profile; admission still requires exact-digest approval | Observed Hermes v0.18.2, v0.19.0, and v0.20.0 CLIs, isolated curator-Cron lifecycle, and Daidala start CLI/tool schemas |
