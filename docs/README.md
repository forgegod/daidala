...
| [Autonomous self-improvement flow](15-self-improvement.md) | Phase 3 read-only prerequisite diagnosis, strict credential bindings, reports, and prior-receipt validation implemented; live setup/evaluator remains blocked | Pure, fake-command, and adapter tests, project fixture, versioned result, and both implementation plans |
| [Self-improvement environment prerequisites](16-self-improvement-setup.md) | Normative setup and remediation guide with stable check IDs and implemented read-only CLI checker; container, Project scopes, least-privilege aliases, and attended gateway remain host blockers | CLI parity and fail-closed tests, both implementation plans, and current official Hermes, GitHub CLI, and Docker documentation |
