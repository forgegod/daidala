...
def test_version_constraint_has_exact_bounded_semantics() -> None:
    ...
    assert version_satisfies("0.20.0", constraint)
    assert version_satisfies("0.20.9", constraint)
    assert not version_satisfies("0.21.0", constraint)
